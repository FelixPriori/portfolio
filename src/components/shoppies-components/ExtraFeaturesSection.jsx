...
import {Row, Col, Card, CardBody, CardText, Spinner, Container} from 'reactstrap'
        ...
        <SubSection>
          <Row>
            <Col lg={6}>
              ...
              <Paragraph>
                Behind the scenes, the status of the search will update while the user interacts with the search bar.
        ...
        <SubSection>
          <Row>
            <Col lg={6}>
              <h3>Movie Card</h3>
              <Paragraph>
                In addition to the required title and date, I decided to also show the user the movie poster, and in
                case the poster was not available, show a custom fallback image instead.
              </Paragraph>
              <Paragraph>
                The buttons at the bottom of the app will appear and change depending on whether or not the movie is in
                the nomination list or not.
              </Paragraph>
            </Col>
            <Col>
              <PostersContainer>
          ...
          <Row>
            <Col lg={6}>
              ...
              <ul>
                ...
                <li>
                  A counter at the top of the nominations list keeps track of how many nominations are in the list out
                  of 5.
                </li>
                <li>
                  A small delay is added to the search so that the app does not hammer the API on each keystroke.
                  Instead, it waits for the user to finish typing before triggering the search.
                </li>
